...
CREATE TABLE `tblcomplaint` (
  ...
  `complaintMsg` varchar(255) NOT NULL,
  `complaintDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `userId` int(11) NOT NULL,
  PRIMARY KEY (`complaintID`),
  UNIQUE KEY `complaintDate_UNIQUE` (`complaintDate`),
  KEY `userId` (`userId`),
  CONSTRAINT `tblcomplaint_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `tbluser` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `tblcomplaint` WRITE;
